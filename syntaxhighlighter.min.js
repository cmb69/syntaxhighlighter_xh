 ...
 */
 ...
 (function () {
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        var config = JSON.parse(document.getElementsByName("syntaxhighlighter.config")[0].content);
        for (const prop in config) {
            SyntaxHighlighter.defaults[prop] = config[prop];
        }
        var strings = JSON.parse(document.getElementsByName("syntaxhighlighter.strings")[0].content);
